"""
Django settings for square_fire_42295 project.
...
ROOT_URLCONF = 'square_fire_42295.urls'
...
WSGI_APPLICATION = 'square_fire_42295.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_fire_42295 API",
    "DESCRIPTION": "API documentation for square_fire_42295 App",
    "VERSION": "v1",
}
